export default {
  ...
  "request": {
    ...
    "login": {
      ...
      "card-number-label": "Personnummer eller nummer på bibliotekskort",
      "card-number-label-placeholder": "ÅÅÅÅMMDDXXXX eller tio siffror på bibliotekskort",
      "card-number-label-extra-info": "Personnummer eller nummer på GU-kort eller bibliotekskort",
      "card-number-label-extra-info-placeholder": "ÅÅÅÅMMDDXXXX eller tio siffror på GU-kort eller bibliotekskort",
      ...
      "library-card-number-pin-code-login-error": "Fel personnummer / bibliotekskortsnummer eller PIN-kod. Vänligen försök igen.",
